...
export const MarketWinnersWidget = () => {
  const winners = [
    { symbol: 'BONK', name: 'Bonk', change: '+45.2%', icon: '🔨', price: '$0.0012' },
    { symbol: 'PEPE', name: 'Pepe', change: '+38.7%', icon: '🐸', price: '$0.0089' },
    { symbol: 'FET', name: 'Fetch.ai', change: '+28.4%', icon: '🤖', price: '$2.34' },
    { symbol: 'RNDR', name: 'Render', change: '+22.1%', icon: '🎨', price: '$8.67' },
  ];

  const losers = [
    { symbol: 'DASH', name: 'Dash', change: '-8.5%', icon: '💨', price: '$45.23' },
    { symbol: 'XMR', name: 'Monero', change: '-6.2%', icon: '🔒', price: '$156.78' },
    { symbol: 'ZEC', name: 'Zcash', change: '-5.8%', icon: '🛡️', price: '$34.56' },
    { symbol: 'CAKE', name: 'PancakeSwap', change: '-4.3%', icon: '🥞', price: '$2.89' },
  ];
