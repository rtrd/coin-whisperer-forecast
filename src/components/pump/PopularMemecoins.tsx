...
import { TrendingUp, TrendingDown, Crown, Volume2, Flame, RefreshCw } from "lucide-react";
          ...
          <div className="flex items-center gap-2">
            <Select value={sortBy} onValueChange={(value: SortOption) => setSortBy(value)}>
              ...
              <SelectContent className="bg-gray-800 border-gray-600">
                ...
                <SelectItem value="market_cap" className="text-white hover:bg-gray-700">Market Cap</SelectItem>
                <SelectItem value="price_change_24h" className="text-white hover:bg-gray-700">24h Change</SelectItem>
                <SelectItem value="pump_score" className="text-white hover:bg-gray-700">Pump Score</SelectItem>
              </SelectContent>
            </Select>
            <Button
              variant="outline"
