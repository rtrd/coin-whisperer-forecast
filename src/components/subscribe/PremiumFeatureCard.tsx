    ...
    `}>
      <div className="flex items-start gap-4">
        <div className={`
          p-3 rounded-lg
          ${highlight 
            ? 'bg-gradient-to-br from-premium to-premium-end text-white' 
      ...
      {highlight && (
        <div className="absolute -top-3 -right-3 bg-crypto-gold text-black text-xs px-3 py-1 rounded-full font-bold animate-pulse-slow">
          MOST POPULAR
        </div>
      )}
    </div>
