  ...
  const fetchSentimentData = async () => {
    ...
    try {
      ...
      const totalSentiment = sentimentResults.reduce(
        (sum, crypto) => sum + crypto.sentiment,
        0
      );
      ...
      setOverallSentiment({
        ...
        trend:
          avgSentiment >= 70
            ...
            : "Bearish",
        confidence:
          avgSentiment >= 70 || avgSentiment <= 30 ? "High" : "Medium",
        change:
          avgSentiment > 50
            ? "Rising"
            : avgSentiment < 50
                ...
                <CardContent className="p-4 sm:p-6 lg:p-8">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    ...
                    <div className="text-center p-6 bg-gradient-to-br from-purple-600/20 to-pink-600/20 rounded-xl border border-purple-500/30 hover:shadow-lg transition-all">
                      ...
                      <p className="text-gray-300 text-sm">
                        Natural language processing algorithms identify
                    ...
                    <div className="text-center p-6 bg-gradient-to-br from-orange-600/20 to-red-600/20 rounded-xl border border-orange-500/30 hover:shadow-lg transition-all">
                      ...
                      <p className="text-gray-300 text-sm">
                        Multiple data sources combined to provide comprehensive
                        sentiment insights
                      </p>
                    </div>
                    ...
                    <div className="text-center p-6 bg-gradient-to-br from-cyan-600/20 to-blue-600/20 rounded-xl border border-cyan-500/30 hover:shadow-lg transition-all">
                      ...
                      <p className="text-gray-300 text-sm">
                        Sentiment scores updated every 5 minutes for live
                        tracking
                      </p>
                    </div>
                    ...
                    <div className="text-center p-6 bg-gradient-to-br from-yellow-600/20 to-orange-600/20 rounded-xl border border-yellow-500/30 hover:shadow-lg transition-all">
                      ...
                      <p className="text-gray-300 text-sm">
                        Pattern recognition for identifying sentiment momentum
                        shifts
                      </p>
                    </div>
                  </div>
              ...
              <Card className="bg-gray-800/50 border-gray-700 shadow-xl backdrop-blur-sm">
                <CardHeader className="bg-gradient-to-r from-green-600/10 to-cyan-600/10 border-b border-gray-600/50">
                  ...
                  <p className="text-gray-300 mt-2">
                    Powered by LunarCrush's comprehensive social and market data
                  </p>
                </CardHeader>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-300 text-sm mb-3">
                          Our sentiment analysis is powered by LunarCrush, a
                          leading cryptocurrency social analytics platform that
                          tracks and analyzes social media activity across
                          multiple platforms.
                        </p>
                        <div className="bg-gray-700/30 p-3 rounded-lg">
                          <p className="text-gray-400 text-xs">
                            <strong>Disclaimer:</strong> Sentiment data is
                            provided by LunarCrush and processed through their
                            proprietary algorithms. Scores represent social
                            sentiment trends and should not be considered
                            financial advice.
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-gray-700/30 p-4 rounded-lg">
                      ...
                      <ul className="text-gray-300 text-sm space-y-2">
                        <li>
                          • <span className="text-blue-400">Social Score:</span>{" "}
                          Overall social activity level
                        </li>
                        <li>
                          •{" "}
                          <span className="text-green-400">Galaxy Score:</span>{" "}
                          Comprehensive performance metric
                        </li>
                        <li>
                          • <span className="text-purple-400">Alt Rank:</span>{" "}
                          Relative ranking among altcoins
                        </li>
                        <li>
                          •{" "}
              ...
              <Card className="bg-gray-800/50 border-gray-700 shadow-xl backdrop-blur-sm overflow-hidden relative">
                ...
                <CardContent className="relative z-10 p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div
                      className={`group text-center p-6 rounded-xl border transition-all duration-300 hover:shadow-lg ${
                        overallSentiment.trend === "Bullish"
                    ...
                    >
                      <div
                        className={`inline-flex items-center justify-center w-12 h-12 rounded-full mb-3 group-hover:scale-110 transition-transform ${
                          overallSentiment.trend === "Bullish"
                            ? "bg-green-500/20"
                            : overallSentiment.trend === "Bearish"
                            ? "bg-red-500/20"
              ...
              <Card className="bg-gray-800/50 border-gray-700 shadow-xl backdrop-blur-sm overflow-hidden relative">
                ...
                <CardHeader className="relative z-10 bg-gradient-to-r from-blue-600/10 to-purple-600/10 border-b border-gray-600/50">
                  ...
                  <CardDescription className="text-gray-300">
                    Real-time sentiment scores and trends for major
                    cryptocurrencies
                  </CardDescription>
                </CardHeader>
                  ...
                  {isLoading ? (
                    <div className="space-y-4">
                      {[...Array(5)].map((_, i) => (
                        <div
                          key={i}
                          className="animate-pulse flex items-center justify-between p-5 bg-gray-700/30 rounded-xl border border-gray-600/50"
                        >
                      ...
                      {topCryptosSentiment.map((crypto, index) => {
                        ...
                        const getGradientClasses = (
                          ...
                          switch (color) {
                            case "orange":
                              return isPositive
                                ? "from-orange-600/20 to-yellow-600/20 border-orange-500/30 hover:border-orange-400/50"
                                : "from-orange-600/10 to-red-600/10 border-orange-500/20 hover:border-orange-400/30";
                            case "blue":
                              return isPositive
                                ? "from-blue-600/20 to-cyan-600/20 border-blue-500/30 hover:border-blue-400/50"
                                : "from-blue-600/10 to-gray-600/10 border-blue-500/20 hover:border-blue-400/30";
                            case "purple":
                              return isPositive
                                ? "from-purple-600/20 to-pink-600/20 border-purple-500/30 hover:border-purple-400/50"
                                : "from-purple-600/10 to-gray-600/10 border-purple-500/20 hover:border-purple-400/30";
                            case "red":
                            ...
                            case "green":
                              return isPositive
                                ...
                                : "from-green-600/10 to-gray-600/10 border-green-500/20 hover:border-green-400/30";
                            default:
                        ...
                        return (
                          <Link
                            key={crypto.symbol}
                            to={`/token/${crypto.id}`}
                            className={`group flex items-center justify-between p-5 bg-gradient-to-r ${getGradientClasses(
                              crypto.color,
                              crypto.sentiment
                            )} rounded-xl border transition-all duration-300 hover:shadow-lg cursor-pointer ${
                              isTop3 ? "ring-1 ring-yellow-400/30" : ""
                            }`}
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                ...
                                <div className="text-gray-400 text-sm">
                                  Sentiment rank #{crypto.position}
                                </div>
                              </div>
                            </div>
                            <div className="flex items-center gap-4">
                ...
                <CardHeader className="bg-gradient-to-r from-pink-600/10 to-purple-600/10 border-b border-gray-600/50">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 mt-2">
                        Get real-time market sentiment powered by advanced AI
                  ...
                  <Accordion type="single" collapsible className="space-y-3">
                    ...
                    >
                      ...
                      <AccordionContent className="text-gray-300 pt-4 leading-relaxed">
                        Pump Parade's Sentiment Analysis uses advanced natural
                        language processing (NLP) to analyze millions of social
                        media posts, news articles, and forum discussions in
                        real-time. Our AI identifies positive, negative, and
                        neutral sentiment towards cryptocurrencies, providing
                        market sentiment scores that help predict price
                        movements and market trends.
                      </AccordionContent>
                    </AccordionItem>

                    <AccordionItem
                      value="how-algorithm-works"
                    ...
                    >
                      ...
                      <AccordionContent className="text-gray-300 pt-4 leading-relaxed">
                        Pump Parade integrates with LunarCrush's API to access
                        their comprehensive social analytics. LunarCrush uses
                        machine learning algorithms to analyze social media
                        posts, news articles, and community discussions. Their
                        system processes text for sentiment polarity, engagement
                        metrics, and influence scores to generate comprehensive
                    ...
                    >
                      ...
                      <AccordionContent className="text-gray-300 pt-4 leading-relaxed">
                        Through LunarCrush's platform, we access data from major
                        social media platforms including Twitter/X, Reddit, and
                        various crypto communities. LunarCrush aggregates social
                        mentions, engagement metrics, and sentiment indicators
                        from these sources to provide comprehensive social
                        analytics for cryptocurrency markets.
                      </AccordionContent>
                    </AccordionItem>

                    <AccordionItem
                      value="sentiment-scoring"
                    ...
                    >
                      ...
                      <AccordionContent className="text-gray-300 pt-4 leading-relaxed">
                        Sentiment scores range from 0-100, where 0-30 is
                        bearish, 30-70 is neutral, and 70-100 is bullish. We use
                        a weighted compound score that considers sentiment
                        polarity (-1 to +1), source reliability (0.1-1.0), user
                        influence (1-10), and time decay factors. The final
                        score is normalized and smoothed using exponential
                        moving averages.
                      </AccordionContent>
                    </AccordionItem>

                    <AccordionItem
                      value="accuracy-reliability"
                    ...
                    >
                      ...
                      <AccordionContent className="text-gray-300 pt-4 leading-relaxed">
                        Our sentiment analysis shows 78-85% correlation with
                        short-term price movements (1-24 hours) and 65-72%
                        correlation with medium-term trends (1-7 days).
                        Sentiment is most effective when combined with technical
                        analysis and volume indicators. Extreme sentiment
                        readings often signal potential reversals.
                      </AccordionContent>
                    </AccordionItem>
                    ...
                    >
                      ...
                      <AccordionContent className="text-gray-300 pt-4 leading-relaxed">
                        Sentiment scores are updated every 5 minutes during
                        active market hours and every 15 minutes during
                        off-hours. Our system processes approximately 100,000+
                        mentions per hour across all monitored sources. Breaking
                        news events and viral posts can trigger immediate
                        recalculation of sentiment scores.
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
                </CardContent>
