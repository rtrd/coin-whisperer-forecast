...
import { TrendingUp, Flame, Clock, Users, BarChart3, ShoppingCart, TrendingDown, Home, Search, User } from "lucide-react";
...
const MotiMeter = () => {
  ...
  useEffect(() => {
    ...
    // Display bottom ad
    if (window.googletag && window.googletag.display) {
      window.googletag.display('div-gpt-ad-bottom-moti');
    }
  }, []);
        ...
        <div className="flex">
          ...
          <div className="flex-1 container mx-auto px-4 py-8">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {motiTokens?.map((token, index) => (
                      <React.Fragment key={token.id}>
                        ...
                        {/* Native Ad every 4 tokens */}
                        {(index + 1) % 4 === 0 && index < 9 && (
                          <Card className="bg-blue-900/20 border-blue-700 border-dashed">
                            <CardContent className="p-6 text-center">
                              <div className="text-blue-400 mb-2">
                                <span className="text-xs uppercase tracking-wide">Sponsored</span>
                              </div>
                              <h3 className="text-white font-semibold mb-2">Trade Crypto with Zero Fees</h3>
                              <p className="text-gray-300 text-sm mb-4">
                                Join millions trading meme coins on the fastest DEX
                              </p>
            ...
            <div className="flex justify-center mt-8 mb-8">
              <div id='div-gpt-ad-bottom-moti' style={{minWidth: '728px', minHeight: '90px'}}></div>
            </div>
          </div>

          {/* Sidebar */}
          <div className="w-80 bg-gray-800/30 border-l border-gray-700 p-6 hidden lg:block">
