                ...
                <CardContent className="p-8">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    ...
                    <div className="text-center p-6 bg-gradient-to-br from-purple-600/20 to-pink-600/20 rounded-xl border border-purple-500/30 hover:shadow-lg transition-all">
                      ...
                      <p className="text-gray-300 text-sm">
                        Analysis across 1m, 5m, 15m, 1h, 4h, 1d, and weekly
                        charts
                      </p>
                    </div>
                    ...
                    <div className="text-center p-6 bg-gradient-to-br from-orange-600/20 to-red-600/20 rounded-xl border border-orange-500/30 hover:shadow-lg transition-all">
                      ...
                      <p className="text-gray-300 text-sm">
                        Dynamic S/R levels calculated using volume and price
                        action
                      </p>
                    </div>
                    ...
                    <div className="text-center p-6 bg-gradient-to-br from-cyan-600/20 to-blue-600/20 rounded-xl border border-cyan-500/30 hover:shadow-lg transition-all">
                      ...
                      <p className="text-gray-300 text-sm">
                        Backtested algorithms with proven 78% success rate
                      </p>
                    </div>
                    ...
                    <div className="text-center p-6 bg-gradient-to-br from-pink-600/20 to-rose-600/20 rounded-xl border border-pink-500/30 hover:shadow-lg transition-all">
                      ...
                      <p className="text-gray-300 text-sm">
                        AI-powered detection of head & shoulders, triangles,
                        flags
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 mt-2">
                        Mathematical formulas and algorithms behind our
                        indicators
                      </p>
                    </div>
                  </div>
              ...
              <Card className="bg-gray-800/50 border-gray-700 shadow-xl backdrop-blur-sm">
                <CardHeader className="bg-gradient-to-r from-blue-600/10 to-purple-600/10 border-b border-gray-600/50">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 mt-2">
                        Common questions about our technical analysis tools
                      </p>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="p-6">
                  <Accordion type="single" collapsible className="space-y-3">
                    <AccordionItem
                      value="what-is-technical-analysis"
                    ...
                    >
                      ...
                      <AccordionContent className="text-gray-300 pt-4 leading-relaxed">
                        ...
                        cryptocurrency prices by analyzing statistical trends
                        gathered from trading activity, such as price movement
                        and volume. Our platform uses advanced mathematical
                        indicators like RSI, MACD, and Bollinger Bands to
                        identify potential trading opportunities and market
                        trends.
                      </AccordionContent>
                    </AccordionItem>

                    <AccordionItem
                      value="how-indicators-work"
                    ...
                    >
                      ...
                      <AccordionContent className="text-gray-300 pt-4 leading-relaxed">
                        Our technical indicators use mathematical formulas
                        applied to price and volume data. For example, RSI
                        measures the speed and magnitude of price changes to
                        identify overbought/oversold conditions. MACD compares
                        two moving averages to reveal trend changes. Each
                        indicator provides unique insights that work together
                    ...
                    >
                      ...
                      <AccordionContent className="text-gray-300 pt-4 leading-relaxed">
                        Our backtesting shows 78% accuracy for combined
                        indicator signals over 2+ years of historical data.
                        Individual indicators vary in accuracy - RSI and MACD
                        perform best on trending markets, while Bollinger Bands
                        excel in ranging conditions. We recommend using multiple
                        indicators together rather than relying on single
                        signals.
                      </AccordionContent>
                    </AccordionItem>
                    ...
                    >
                      ...
                      <AccordionContent className="text-gray-300 pt-4 leading-relaxed">
                        Different timeframes serve different purposes: 1-15
                        minute charts for scalping, 1-4 hour charts for day
                        trading, and daily/weekly charts for swing trading. Our
                        platform analyzes all timeframes simultaneously, with
                        higher timeframes providing stronger trend direction and
                        lower timeframes offering precise entry/exit points.
                      </AccordionContent>
                    </AccordionItem>
                    ...
                    >
                      ...
                      <AccordionContent className="text-gray-300 pt-4 leading-relaxed">
                        We use volume-weighted price analysis and historical
                        pivot points to identify support/resistance levels. Our
                        algorithm considers price rejection areas, volume
                        spikes, and Fibonacci retracement levels. Dynamic levels
                        update in real-time as new price action confirms or
                        invalidates previous levels, providing the most accurate
                        trading zones.
                      </AccordionContent>
                    </AccordionItem>
                    ...
                    >
                      ...
                      <AccordionContent className="text-gray-300 pt-4 leading-relaxed">
                        Always use multiple indicators for confirmation, respect
                        risk management rules (never risk more than 2% per
                        trade), and combine technical analysis with fundamental
                        analysis. Wait for multiple timeframe alignment, use
                        proper position sizing, and remember that technical
                        analysis works best in liquid markets like Bitcoin and
                        Ethereum.
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
