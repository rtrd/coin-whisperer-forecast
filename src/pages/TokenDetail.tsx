      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="space-y-6">
            ...
            {/* AI Prediction Engine - Moved Below Chart */}
            <Card className="bg-gray-800/50 border-gray-700 shadow-2xl">
              <CardHeader>
                <CardTitle className="text-white flex items-center gap-2">
              ...
              <CardContent>
                <div className="bg-gradient-to-r from-gray-700/30 to-gray-800/30 rounded-xl p-8 border border-gray-600/30 backdrop-blur-sm">
                  <div className="flex flex-col space-y-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        <h3 className="text-white font-semibold text-lg">Generate AI Price Predictions</h3>
                        <p className="text-gray-300 text-sm">Advanced forecasting using machine learning models</p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div className="flex flex-col gap-3">
                        ...
                        <Select value={predictionDays.toString()} onValueChange={(value) => setPredictionDays(Number(value))}>
                          ...
                          <SelectContent className="bg-gray-800 backdrop-blur-sm border-gray-600 shadow-xl rounded-xl">
            ...
            {/* Ad Banner After AI Prediction Engine - Centered */}
            <div className="w-full min-h-[120px] bg-gray-800/50 border border-gray-700 rounded-lg overflow-hidden flex items-center justify-center">
              <AdBanner width={728} height={120} position="horizontal" className="max-w-full h-full" />
            </div>
          </div>
