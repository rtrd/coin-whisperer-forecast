...
export const generateHomepageSEO = (): PageSEOData => {
  return {
    ...
    description:
      "Crypto research and market analysis tools with AI-powered technical analysis, price prediction, and real-time sentiment tracking.",
    keywords:
      "cryptocurrency analysis, AI price predictions, crypto trading signals, bitcoin prediction, ethereum analysis, market sentiment, technical analysis, pump parade",
      ...
      "@graph": [
        {
          ...
          url: "https://pumpparade.com",
          description:
            "AI-powered cryptocurrency analysis and price predictions",
          publisher: {
        ...
        },
        {
          ...
          sameAs: ["https://twitter.com/PumpParade"],
        },
        {
          "@type": "WebPage",
          ...
          description:
            "Get AI-powered cryptocurrency analysis, price predictions, and trading signals. Track market trends, sentiment analysis, and technical indicators for informed crypto investing.",
          isPartOf: {
            "@id": "https://pumpparade.com/#website",
          },
          about: {
...
export const generateBlogSEO = (): PageSEOData => {
  return {
    ...
    description:
      "Latest crypto news, market analysis, and trading insights. Expert content on Bitcoin, Ethereum, DeFi, and altcoin trends.",
    keywords:
      "crypto news, cryptocurrency blog, market analysis, trading insights, bitcoin news, ethereum updates, DeFi analysis, crypto trends",
      ...
      "@graph": [
        {
          ...
          description:
            "Advanced machine learning algorithm for accurate cryptocurrency price predictions",
        ...
        },
        {
          ...
          description:
            "Free AI-powered cryptocurrency price prediction tool using machine learning algorithms",
          featureList: [
...
export const generateMotiMeterSEO = (): PageSEOData => {
  return {
    title:
      "MOTI Meter | Memecoin Momentum and Social Sentiment Tracker | Pump Parade",
    description:
      "Track hot meme coins with MOTI scoring. Find trending tokens based on viral energy, community momentum, and social sentiment for gains.",
    keywords:
      "MOTI meter, memecoin tracker, social sentiment analysis, meme coin momentum, viral crypto tokens, community sentiment, trending memecoins",
...
export const generateAllTokensSEO = (): PageSEOData => {
  return {
    ...
    description:
      "Complete cryptocurrency market data and analysis for all tokens. Filter crypto assets with real-time prices, market cap, and volume.",
    keywords:
      "all cryptocurrencies, crypto market data, token prices, cryptocurrency list, market cap rankings, crypto trading data, altcoin analysis",
    canonical: "https://pumpparade.com/tokens",
    openGraph: {
      title: "All Cryptocurrency Tokens & Market Data | Pump Parade",
      description:
        "Complete cryptocurrency market data, prices, and analysis for all tokens. Filter and compare crypto assets with real-time data.",
      type: "website",
...
export const generatePumpFunSEO = (): PageSEOData => {
  return {
    ...
    description:
      "Discover trending Solana memecoins and new token launches from Pump.fun. Find the next viral Solana token with real-time data.",
    keywords:
      "pump.fun integration, Solana memecoins, new token launches, trending Solana tokens, memecoin tracker, Solana DeFi, viral tokens",
    canonical: "https://pumpparade.com/pump-fun",
    openGraph: {
      title: "Solana Memecoin Tracker | Pump.fun Integration | Pump Parade",
      description:
        "Discover and track trending Solana memecoins and new token launches from Pump.fun with real-time data and insights.",
      type: "website",
...
export const generateTechnicalAnalysisSEO = (): PageSEOData => {
  return {
    ...
    description:
      "Professional crypto technical analysis with RSI, MACD, chart patterns, and trading signals for informed decisions.",
    keywords:
      "crypto technical analysis, trading indicators, chart patterns, RSI, MACD, moving averages, crypto trading signals, technical indicators",
    canonical: "https://pumpparade.com/technical-analysis",
    openGraph: {
      title: "Cryptocurrency Technical Analysis Tools | Pump Parade",
      description:
        "Professional crypto technical analysis with advanced indicators, chart patterns, and trading signals for informed decisions.",
      type: "website",
...
export const generateSentimentAnalysisSEO = (): PageSEOData => {
  return {
    ...
    description:
      "AI-powered crypto sentiment analysis from social media and news to gauge market emotions and predict price movements.",
    keywords:
      "crypto sentiment analysis, market sentiment, social media crypto analysis, news sentiment, market emotions, sentiment indicators, crypto psychology",
    canonical: "https://pumpparade.com/sentiment-analysis",
    openGraph: {
      title: "Crypto Market Sentiment Analysis | Pump Parade",
      description:
        "AI-powered cryptocurrency sentiment analysis from social media, news, and market data to gauge market emotions and predict price movements.",
      type: "website",
...
export const generateSubscribeSEO = (): PageSEOData => {
  return {
    ...
    description:
      "Unlock premium crypto analysis with advanced AI predictions, real-time alerts, exclusive insights, and ad-free experience.",
    keywords:
      "crypto premium subscription, advanced crypto analysis, premium trading signals, crypto alerts, professional crypto tools, trading subscription",
    canonical: "https://pumpparade.com/subscribe",
    openGraph: {
      title: "Premium Crypto Analysis Subscription | Pump Parade",
      description:
        "Unlock premium cryptocurrency analysis features including advanced AI predictions, real-time alerts, exclusive insights, and ad-free experience.",
      type: "website",
...
export const generateArticleSEO = (article: any): PageSEOData => {
  ...
  const description =
    article.excerpt ||
    article.description ||
    "Read the latest cryptocurrency news and analysis on Pump Parade.";
  ...
  return {
    ...
    description,
    keywords: `${
      article.tags || article.tagNames?.join(", ") || ""
    }, cryptocurrency news, crypto analysis, ${article.category}`,
      ...
      "@graph": [
        {
          ...
          author: {
            "@type": "Person",
            "@id": `https://pumpparade.com/author/${String(
              article.author || "pump-parade-team"
            )
              .toLowerCase()
              .replace(/\s+/g, "-")}#person`,
...
export const generateRealTimeDataSEO = (): PageSEOData => {
  return {
    ...
    description:
      "Live cryptocurrency prices, market cap, volume, and real-time trading data. Track crypto markets with instant updates and alerts.",
    keywords:
      "real-time crypto data, live cryptocurrency prices, crypto market cap live, trading volume real-time, crypto price alerts, live market data",
    canonical: "https://pumpparade.com/real-time-data",
    openGraph: {
      title: "Real-Time Cryptocurrency Data & Live Prices | Pump Parade",
      description:
        "Get live cryptocurrency prices, market cap, volume, and real-time trading data with instant updates and price alerts.",
      type: "website",
...
export const generatePortfolioTrackingSEO = (): PageSEOData => {
  return {
    ...
    description:
      "Track your cryptocurrency portfolio with real-time performance analytics, profit/loss calculations, and portfolio insights.",
    keywords:
      "crypto portfolio tracker, cryptocurrency portfolio management, crypto holdings tracker, portfolio performance, crypto profit loss calculator",
    canonical: "https://pumpparade.com/portfolio-tracking",
    openGraph: {
      title: "Crypto Portfolio Tracker | Track Your Holdings | Pump Parade",
      description:
        "Advanced cryptocurrency portfolio tracking with real-time performance analytics, profit/loss calculations, and detailed insights.",
      type: "website",
...
export const generatePortfolioDashboardSEO = (): PageSEOData => {
  return {
    ...
    description:
      "Professional crypto portfolio dashboard with advanced analytics, risk analysis, performance metrics, and trading insights.",
    keywords:
      "crypto portfolio dashboard, portfolio analytics, crypto risk analysis, portfolio performance metrics, crypto trading dashboard, investment analytics",
    canonical: "https://pumpparade.com/portfolio-dashboard",
    openGraph: {
      title:
        "Advanced Portfolio Dashboard | Analytics & Insights | Pump Parade",
      description:
        "Professional cryptocurrency portfolio dashboard with advanced analytics, risk analysis, performance metrics, and trading insights.",
      type: "website",
...
export const generateAIPricePredictionSEO = (): PageSEOData => {
  return {
    title:
      "AI Price Prediction Models | Advanced Crypto Forecasting | Pump Parade",
    description:
      "Advanced AI-powered cryptocurrency price prediction models with machine learning algorithms, accuracy metrics, and forecasting insights.",
    keywords:
      "AI price prediction models, crypto forecasting algorithms, machine learning price prediction, cryptocurrency prediction accuracy, AI trading models",
...
// Token Detail SEO
export const generateTokenDetailSEO = (
  tokenId: string,
  tokenData?: any
): PageSEOData => {
...
export const generateNotFoundSEO = (): PageSEOData => {
  return {
    ...
    description:
      "The page you're looking for doesn't exist. Explore our crypto analysis tools, AI predictions, and market insights.",
    keywords: "404 error, page not found, crypto analysis, pump parade",
    canonical: "https://pumpparade.com/404",
    openGraph: {
      title: "Page Not Found | Pump Parade",
      description:
        "The page you're looking for doesn't exist. Explore our cryptocurrency analysis tools, AI predictions, and market insights.",
      type: "website",
